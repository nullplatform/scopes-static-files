...
# | CNAME target                     | Non-empty (points to SWA)              |
# | TTL                              | > 0                                    |
# +----------------------------------+----------------------------------------+
assert_azure_dns_configured() {
	...
	# CNAME target (should point to Static Web App)
	local cname_target
	...
	# The CNAME should point to the Azure Static Web App (azurestaticapps.net)
	assert_contains "$cname_target" "azurestaticapps.net"
