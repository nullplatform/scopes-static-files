...
**Run:** `make -C testing test-unit` or `make -C testing test-unit MODULE=frontend`
...
**Run:** `make -C testing test-tofu` or `make -C testing test-tofu MODULE=frontend`
...
**Run:** `make -C testing test-integration` or `make -C testing test-integration MODULE=frontend`
...
make -C testing test-unit              # BATS unit tests for bash scripts
